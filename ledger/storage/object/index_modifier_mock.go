...
func (m *mIndexModifierMockSet) Expect(p context.Context, p1 core.RecordID, p2 Lifeline) *mIndexModifierMockSet {
	m.mock.SetFunc = nil
...
func (m *mIndexModifierMockSet) ExpectOnce(p context.Context, p1 core.RecordID, p2 Lifeline) *IndexModifierMockSetExpectation {
	m.mock.SetFunc = nil
...
func (m *mIndexModifierMockSet) Set(f func(p context.Context, p1 core.RecordID, p2 Lifeline) (r error)) *IndexModifierMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *IndexModifierMock) Set(p context.Context, p1 core.RecordID, p2 Lifeline) (r error) {
