...
type CleanerMock struct {
	...
	CleanJetIndexesFunc       func(p context.Context, p1 insolar.ID, p2 recentstorage.RecentIndexStorage, p3 []insolar.ID) (r RmStat, r1 error)
	CleanJetIndexesCounter    uint64
	CleanJetIndexesPreCounter uint64
	CleanJetIndexesMock       mCleanerMockCleanJetIndexes

	CleanJetRecordsUntilPulseFunc       func(p context.Context, p1 insolar.ID, p2 insolar.PulseNumber) (r map[string]RmStat, r1 error)
...
func (m *mCleanerMockCleanJetIndexes) Expect(p context.Context, p1 insolar.ID, p2 recentstorage.RecentIndexStorage, p3 []insolar.ID) *mCleanerMockCleanJetIndexes {
...
func (m *mCleanerMockCleanJetIndexes) ExpectOnce(p context.Context, p1 insolar.ID, p2 recentstorage.RecentIndexStorage, p3 []insolar.ID) *CleanerMockCleanJetIndexesExpectation {
	m.mock.CleanJetIndexesFunc = nil
...
func (m *mCleanerMockCleanJetIndexes) Set(f func(p context.Context, p1 insolar.ID, p2 recentstorage.RecentIndexStorage, p3 []insolar.ID) (r RmStat, r1 error)) *CleanerMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *CleanerMock) CleanJetIndexes(p context.Context, p1 insolar.ID, p2 recentstorage.RecentIndexStorage, p3 []insolar.ID) (r RmStat, r1 error) {
...
func (m *mCleanerMockCleanJetRecordsUntilPulse) Expect(p context.Context, p1 insolar.ID, p2 insolar.PulseNumber) *mCleanerMockCleanJetRecordsUntilPulse {
...
func (m *mCleanerMockCleanJetRecordsUntilPulse) ExpectOnce(p context.Context, p1 insolar.ID, p2 insolar.PulseNumber) *CleanerMockCleanJetRecordsUntilPulseExpectation {
	m.mock.CleanJetRecordsUntilPulseFunc = nil
	m.mainExpectation = nil
...
func (m *mCleanerMockCleanJetRecordsUntilPulse) Set(f func(p context.Context, p1 insolar.ID, p2 insolar.PulseNumber) (r map[string]RmStat, r1 error)) *CleanerMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *CleanerMock) CleanJetRecordsUntilPulse(p context.Context, p1 insolar.ID, p2 insolar.PulseNumber) (r map[string]RmStat, r1 error) {
