...
type ModifierMock struct {
	...
	SetFunc       func(p context.Context, p1 core.RecordID, p2 Blob) (r error)
	SetCounter    uint64
...
func (m *mModifierMockSet) Expect(p context.Context, p1 core.RecordID, p2 Blob) *mModifierMockSet {
	m.mock.SetFunc = nil
...
func (m *mModifierMockSet) ExpectOnce(p context.Context, p1 core.RecordID, p2 Blob) *ModifierMockSetExpectation {
	m.mock.SetFunc = nil
...
func (m *mModifierMockSet) Set(f func(p context.Context, p1 core.RecordID, p2 Blob) (r error)) *ModifierMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *ModifierMock) Set(p context.Context, p1 core.RecordID, p2 Blob) (r error) {
