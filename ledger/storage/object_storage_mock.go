...
type ObjectStorageMock struct {
	...
	GetBlobFunc       func(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) (r []byte, r1 error)
	GetBlobCounter    uint64
	GetBlobPreCounter uint64
	GetBlobMock       mObjectStorageMockGetBlob

	GetObjectIndexFunc       func(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID, p3 bool) (r *object.Lifeline, r1 error)
	GetObjectIndexCounter    uint64
	GetObjectIndexPreCounter uint64
	GetObjectIndexMock       mObjectStorageMockGetObjectIndex

	GetRecordFunc       func(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) (r object.Record, r1 error)
	GetRecordCounter    uint64
	GetRecordPreCounter uint64
	GetRecordMock       mObjectStorageMockGetRecord

	IterateIndexIDsFunc       func(p context.Context, p1 insolar.RecordID, p2 func(p insolar.RecordID) (r error)) (r error)
	IterateIndexIDsCounter    uint64
	IterateIndexIDsPreCounter uint64
	IterateIndexIDsMock       mObjectStorageMockIterateIndexIDs

	RemoveObjectIndexFunc       func(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) (r error)
	...
	SetBlobFunc       func(p context.Context, p1 insolar.RecordID, p2 insolar.PulseNumber, p3 []byte) (r *insolar.RecordID, r1 error)
	SetBlobCounter    uint64
	SetBlobPreCounter uint64
	SetBlobMock       mObjectStorageMockSetBlob

	SetObjectIndexFunc       func(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID, p3 *object.Lifeline) (r error)
	SetObjectIndexCounter    uint64
	SetObjectIndexPreCounter uint64
	SetObjectIndexMock       mObjectStorageMockSetObjectIndex

	SetRecordFunc       func(p context.Context, p1 insolar.RecordID, p2 insolar.PulseNumber, p3 object.Record) (r *insolar.RecordID, r1 error)
...
func (m *mObjectStorageMockGetBlob) Expect(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) *mObjectStorageMockGetBlob {
...
func (m *mObjectStorageMockGetBlob) ExpectOnce(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) *ObjectStorageMockGetBlobExpectation {
	m.mock.GetBlobFunc = nil
...
func (m *mObjectStorageMockGetBlob) Set(f func(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) (r []byte, r1 error)) *ObjectStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *ObjectStorageMock) GetBlob(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) (r []byte, r1 error) {
...
func (m *mObjectStorageMockGetObjectIndex) Expect(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID, p3 bool) *mObjectStorageMockGetObjectIndex {
...
func (m *mObjectStorageMockGetObjectIndex) ExpectOnce(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID, p3 bool) *ObjectStorageMockGetObjectIndexExpectation {
	m.mock.GetObjectIndexFunc = nil
	m.mainExpectation = nil
...
func (m *mObjectStorageMockGetObjectIndex) Set(f func(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID, p3 bool) (r *object.Lifeline, r1 error)) *ObjectStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *ObjectStorageMock) GetObjectIndex(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID, p3 bool) (r *object.Lifeline, r1 error) {
...
func (m *mObjectStorageMockGetRecord) Expect(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) *mObjectStorageMockGetRecord {
...
func (m *mObjectStorageMockGetRecord) ExpectOnce(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) *ObjectStorageMockGetRecordExpectation {
	m.mock.GetRecordFunc = nil
	m.mainExpectation = nil
...
func (m *mObjectStorageMockGetRecord) Set(f func(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) (r object.Record, r1 error)) *ObjectStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *ObjectStorageMock) GetRecord(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) (r object.Record, r1 error) {
...
type ObjectStorageMockIterateIndexIDsInput struct {
	p  context.Context
	p1 insolar.RecordID
	p2 func(p insolar.RecordID) (r error)
}
...
func (m *mObjectStorageMockIterateIndexIDs) Expect(p context.Context, p1 insolar.RecordID, p2 func(p insolar.RecordID) (r error)) *mObjectStorageMockIterateIndexIDs {
...
func (m *mObjectStorageMockIterateIndexIDs) ExpectOnce(p context.Context, p1 insolar.RecordID, p2 func(p insolar.RecordID) (r error)) *ObjectStorageMockIterateIndexIDsExpectation {
	m.mock.IterateIndexIDsFunc = nil
	m.mainExpectation = nil
...
func (m *mObjectStorageMockIterateIndexIDs) Set(f func(p context.Context, p1 insolar.RecordID, p2 func(p insolar.RecordID) (r error)) (r error)) *ObjectStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *ObjectStorageMock) IterateIndexIDs(p context.Context, p1 insolar.RecordID, p2 func(p insolar.RecordID) (r error)) (r error) {
...
func (m *mObjectStorageMockRemoveObjectIndex) Expect(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) *mObjectStorageMockRemoveObjectIndex {
...
func (m *mObjectStorageMockRemoveObjectIndex) ExpectOnce(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) *ObjectStorageMockRemoveObjectIndexExpectation {
	m.mock.RemoveObjectIndexFunc = nil
	m.mainExpectation = nil
...
func (m *mObjectStorageMockRemoveObjectIndex) Set(f func(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) (r error)) *ObjectStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *ObjectStorageMock) RemoveObjectIndex(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID) (r error) {
...
func (m *mObjectStorageMockSetBlob) Expect(p context.Context, p1 insolar.RecordID, p2 insolar.PulseNumber, p3 []byte) *mObjectStorageMockSetBlob {
...
func (m *mObjectStorageMockSetBlob) Return(r *insolar.RecordID, r1 error) *ObjectStorageMock {
	m.mock.SetBlobFunc = nil
	m.expectationSeries = nil
...
func (m *mObjectStorageMockSetBlob) ExpectOnce(p context.Context, p1 insolar.RecordID, p2 insolar.PulseNumber, p3 []byte) *ObjectStorageMockSetBlobExpectation {
	m.mock.SetBlobFunc = nil
	m.mainExpectation = nil
...
func (e *ObjectStorageMockSetBlobExpectation) Return(r *insolar.RecordID, r1 error) {
	e.result = &ObjectStorageMockSetBlobResult{r, r1}
}

//Set uses given function f as a mock of ObjectStorage.SetBlob method
func (m *mObjectStorageMockSetBlob) Set(f func(p context.Context, p1 insolar.RecordID, p2 insolar.PulseNumber, p3 []byte) (r *insolar.RecordID, r1 error)) *ObjectStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *ObjectStorageMock) SetBlob(p context.Context, p1 insolar.RecordID, p2 insolar.PulseNumber, p3 []byte) (r *insolar.RecordID, r1 error) {
...
func (m *mObjectStorageMockSetObjectIndex) Expect(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID, p3 *object.Lifeline) *mObjectStorageMockSetObjectIndex {
...
func (m *mObjectStorageMockSetObjectIndex) ExpectOnce(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID, p3 *object.Lifeline) *ObjectStorageMockSetObjectIndexExpectation {
	m.mock.SetObjectIndexFunc = nil
	m.mainExpectation = nil
...
func (m *mObjectStorageMockSetObjectIndex) Set(f func(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID, p3 *object.Lifeline) (r error)) *ObjectStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *ObjectStorageMock) SetObjectIndex(p context.Context, p1 insolar.RecordID, p2 *insolar.RecordID, p3 *object.Lifeline) (r error) {
...
func (m *mObjectStorageMockSetRecord) Expect(p context.Context, p1 insolar.RecordID, p2 insolar.PulseNumber, p3 object.Record) *mObjectStorageMockSetRecord {
...
func (m *mObjectStorageMockSetRecord) Return(r *insolar.RecordID, r1 error) *ObjectStorageMock {
	m.mock.SetRecordFunc = nil
	m.expectationSeries = nil
...
func (m *mObjectStorageMockSetRecord) ExpectOnce(p context.Context, p1 insolar.RecordID, p2 insolar.PulseNumber, p3 object.Record) *ObjectStorageMockSetRecordExpectation {
	m.mock.SetRecordFunc = nil
	m.mainExpectation = nil
...
func (e *ObjectStorageMockSetRecordExpectation) Return(r *insolar.RecordID, r1 error) {
	e.result = &ObjectStorageMockSetRecordResult{r, r1}
}

//Set uses given function f as a mock of ObjectStorage.SetRecord method
func (m *mObjectStorageMockSetRecord) Set(f func(p context.Context, p1 insolar.RecordID, p2 insolar.PulseNumber, p3 object.Record) (r *insolar.RecordID, r1 error)) *ObjectStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *ObjectStorageMock) SetRecord(p context.Context, p1 insolar.RecordID, p2 insolar.PulseNumber, p3 object.Record) (r *insolar.RecordID, r1 error) {
