...
type PendingStorageMock struct {
	...
	AddPendingRequestFunc       func(p context.Context, p1 insolar.RecordID, p2 insolar.RecordID)
	...
	GetRequestsFunc       func() (r map[insolar.RecordID]PendingObjectContext)
	GetRequestsCounter    uint64
	GetRequestsPreCounter uint64
	GetRequestsMock       mPendingStorageMockGetRequests

	GetRequestsForObjectFunc       func(p insolar.RecordID) (r []insolar.RecordID)
	...
	RemovePendingRequestFunc       func(p context.Context, p1 insolar.RecordID, p2 insolar.RecordID)
	...
	SetContextToObjectFunc       func(p context.Context, p1 insolar.RecordID, p2 PendingObjectContext)
...
func (m *mPendingStorageMockAddPendingRequest) Expect(p context.Context, p1 insolar.RecordID, p2 insolar.RecordID) *mPendingStorageMockAddPendingRequest {
...
func (m *mPendingStorageMockAddPendingRequest) ExpectOnce(p context.Context, p1 insolar.RecordID, p2 insolar.RecordID) *PendingStorageMockAddPendingRequestExpectation {
	m.mock.AddPendingRequestFunc = nil
...
func (m *mPendingStorageMockAddPendingRequest) Set(f func(p context.Context, p1 insolar.RecordID, p2 insolar.RecordID)) *PendingStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *PendingStorageMock) AddPendingRequest(p context.Context, p1 insolar.RecordID, p2 insolar.RecordID) {
...
type PendingStorageMockGetRequestsResult struct {
	r map[insolar.RecordID]PendingObjectContext
}
...
func (m *mPendingStorageMockGetRequests) Return(r map[insolar.RecordID]PendingObjectContext) *PendingStorageMock {
	m.mock.GetRequestsFunc = nil
	m.expectationSeries = nil
...
func (e *PendingStorageMockGetRequestsExpectation) Return(r map[insolar.RecordID]PendingObjectContext) {
	e.result = &PendingStorageMockGetRequestsResult{r}
}

//Set uses given function f as a mock of PendingStorage.GetRequests method
func (m *mPendingStorageMockGetRequests) Set(f func() (r map[insolar.RecordID]PendingObjectContext)) *PendingStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *PendingStorageMock) GetRequests() (r map[insolar.RecordID]PendingObjectContext) {
...
func (m *mPendingStorageMockGetRequestsForObject) Expect(p insolar.RecordID) *mPendingStorageMockGetRequestsForObject {
...
func (m *mPendingStorageMockGetRequestsForObject) Return(r []insolar.RecordID) *PendingStorageMock {
	m.mock.GetRequestsForObjectFunc = nil
	m.expectationSeries = nil
...
func (m *mPendingStorageMockGetRequestsForObject) ExpectOnce(p insolar.RecordID) *PendingStorageMockGetRequestsForObjectExpectation {
	m.mock.GetRequestsForObjectFunc = nil
	m.mainExpectation = nil
...
func (e *PendingStorageMockGetRequestsForObjectExpectation) Return(r []insolar.RecordID) {
...
func (m *mPendingStorageMockGetRequestsForObject) Set(f func(p insolar.RecordID) (r []insolar.RecordID)) *PendingStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *PendingStorageMock) GetRequestsForObject(p insolar.RecordID) (r []insolar.RecordID) {
...
func (m *mPendingStorageMockRemovePendingRequest) Expect(p context.Context, p1 insolar.RecordID, p2 insolar.RecordID) *mPendingStorageMockRemovePendingRequest {
...
func (m *mPendingStorageMockRemovePendingRequest) ExpectOnce(p context.Context, p1 insolar.RecordID, p2 insolar.RecordID) *PendingStorageMockRemovePendingRequestExpectation {
	m.mock.RemovePendingRequestFunc = nil
	m.mainExpectation = nil
...
func (m *mPendingStorageMockRemovePendingRequest) Set(f func(p context.Context, p1 insolar.RecordID, p2 insolar.RecordID)) *PendingStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *PendingStorageMock) RemovePendingRequest(p context.Context, p1 insolar.RecordID, p2 insolar.RecordID) {
...
func (m *mPendingStorageMockSetContextToObject) Expect(p context.Context, p1 insolar.RecordID, p2 PendingObjectContext) *mPendingStorageMockSetContextToObject {
...
func (m *mPendingStorageMockSetContextToObject) ExpectOnce(p context.Context, p1 insolar.RecordID, p2 PendingObjectContext) *PendingStorageMockSetContextToObjectExpectation {
	m.mock.SetContextToObjectFunc = nil
	m.mainExpectation = nil
...
func (m *mPendingStorageMockSetContextToObject) Set(f func(p context.Context, p1 insolar.RecordID, p2 PendingObjectContext)) *PendingStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *PendingStorageMock) SetContextToObject(p context.Context, p1 insolar.RecordID, p2 PendingObjectContext) {
