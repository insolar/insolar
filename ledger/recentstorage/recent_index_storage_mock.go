...
type RecentIndexStorageMock struct {
	...
	AddObjectFunc       func(p context.Context, p1 insolar.RecordID)
	AddObjectCounter    uint64
	AddObjectPreCounter uint64
	AddObjectMock       mRecentIndexStorageMockAddObject

	AddObjectWithTLLFunc       func(p context.Context, p1 insolar.RecordID, p2 int)
	...
	DecreaseIndexTTLFunc       func(p context.Context) (r []insolar.RecordID)
	...
	FilterNotExistWithLockFunc       func(p context.Context, p1 []insolar.RecordID, p2 func(p []insolar.RecordID))
	...
	GetObjectsFunc       func() (r map[insolar.RecordID]int)
...
func (m *mRecentIndexStorageMockAddObject) Expect(p context.Context, p1 insolar.RecordID) *mRecentIndexStorageMockAddObject {
...
func (m *mRecentIndexStorageMockAddObject) ExpectOnce(p context.Context, p1 insolar.RecordID) *RecentIndexStorageMockAddObjectExpectation {
	m.mock.AddObjectFunc = nil
...
func (m *mRecentIndexStorageMockAddObject) Set(f func(p context.Context, p1 insolar.RecordID)) *RecentIndexStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *RecentIndexStorageMock) AddObject(p context.Context, p1 insolar.RecordID) {
...
func (m *mRecentIndexStorageMockAddObjectWithTLL) Expect(p context.Context, p1 insolar.RecordID, p2 int) *mRecentIndexStorageMockAddObjectWithTLL {
...
func (m *mRecentIndexStorageMockAddObjectWithTLL) ExpectOnce(p context.Context, p1 insolar.RecordID, p2 int) *RecentIndexStorageMockAddObjectWithTLLExpectation {
	m.mock.AddObjectWithTLLFunc = nil
	m.mainExpectation = nil
...
func (m *mRecentIndexStorageMockAddObjectWithTLL) Set(f func(p context.Context, p1 insolar.RecordID, p2 int)) *RecentIndexStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *RecentIndexStorageMock) AddObjectWithTLL(p context.Context, p1 insolar.RecordID, p2 int) {
...
func (m *mRecentIndexStorageMockDecreaseIndexTTL) Return(r []insolar.RecordID) *RecentIndexStorageMock {
	m.mock.DecreaseIndexTTLFunc = nil
	m.expectationSeries = nil
...
func (e *RecentIndexStorageMockDecreaseIndexTTLExpectation) Return(r []insolar.RecordID) {
...
func (m *mRecentIndexStorageMockDecreaseIndexTTL) Set(f func(p context.Context) (r []insolar.RecordID)) *RecentIndexStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *RecentIndexStorageMock) DecreaseIndexTTL(p context.Context) (r []insolar.RecordID) {
...
type RecentIndexStorageMockFilterNotExistWithLockInput struct {
	p  context.Context
	p1 []insolar.RecordID
	p2 func(p []insolar.RecordID)
}

//Expect specifies that invocation of RecentIndexStorage.FilterNotExistWithLock is expected from 1 to Infinity times
func (m *mRecentIndexStorageMockFilterNotExistWithLock) Expect(p context.Context, p1 []insolar.RecordID, p2 func(p []insolar.RecordID)) *mRecentIndexStorageMockFilterNotExistWithLock {
...
func (m *mRecentIndexStorageMockFilterNotExistWithLock) ExpectOnce(p context.Context, p1 []insolar.RecordID, p2 func(p []insolar.RecordID)) *RecentIndexStorageMockFilterNotExistWithLockExpectation {
	m.mock.FilterNotExistWithLockFunc = nil
	m.mainExpectation = nil
...
func (m *mRecentIndexStorageMockFilterNotExistWithLock) Set(f func(p context.Context, p1 []insolar.RecordID, p2 func(p []insolar.RecordID))) *RecentIndexStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *RecentIndexStorageMock) FilterNotExistWithLock(p context.Context, p1 []insolar.RecordID, p2 func(p []insolar.RecordID)) {
...
func (m *mRecentIndexStorageMockGetObjects) Return(r map[insolar.RecordID]int) *RecentIndexStorageMock {
	m.mock.GetObjectsFunc = nil
	m.expectationSeries = nil
...
func (e *RecentIndexStorageMockGetObjectsExpectation) Return(r map[insolar.RecordID]int) {
...
func (m *mRecentIndexStorageMockGetObjects) Set(f func() (r map[insolar.RecordID]int)) *RecentIndexStorageMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *RecentIndexStorageMock) GetObjects() (r map[insolar.RecordID]int) {
