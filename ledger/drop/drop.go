...
//go:generate minimock -i github.com/insolar/insolar/ledger/drop.Modifier -o ./ -s _mock_test.go -g
...
//go:generate minimock -i github.com/insolar/insolar/ledger/drop.Accessor -o ./ -s _mock_test.go -g
...
//go:generate minimock -i github.com/insolar/insolar/ledger/drop.Cleaner -o ./ -s _mock_test.go -g
