...
//go:generate minimock -i github.com/insolar/insolar/ledger/light/hot.WriteAccessor -o ./ -s _mock.go -g
...
//go:generate minimock -i github.com/insolar/insolar/ledger/light/hot.WriteManager -o ./ -s _mock.go -g
