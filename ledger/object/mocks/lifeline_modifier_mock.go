...
func (m *mLifelineModifierMockSet) Expect(p context.Context, p1 insolar.PulseNumber, p2 insolar.ID, p3 object.Lifeline) *mLifelineModifierMockSet {
	...
	m.mainExpectation.input = &LifelineModifierMockSetInput{p, p1, p2, p3}
	return m
}
...
func (m *mLifelineModifierMockSet) ExpectOnce(p context.Context, p1 insolar.PulseNumber, p2 insolar.ID, p3 object.Lifeline) *LifelineModifierMockSetExpectation {
	...
	expectation.input = &LifelineModifierMockSetInput{p, p1, p2, p3}
...
func (m *LifelineModifierMock) Set(p context.Context, p1 insolar.PulseNumber, p2 insolar.ID, p3 object.Lifeline) (r error) {
	...
	if len(m.SetMock.expectationSeries) > 0 {
		if counter > uint64(len(m.SetMock.expectationSeries)) {
			m.t.Fatalf("Unexpected call to LifelineModifierMock.Set. %v %v %v %v", p, p1, p2, p3)
			return
		}

		input := m.SetMock.expectationSeries[counter-1].input
		testify_assert.Equal(m.t, *input, LifelineModifierMockSetInput{p, p1, p2, p3}, "LifelineModifier.Set got unexpected parameters")
