...
func NewRecordCleanerMock(t minimock.Tester) *RecordCleanerMock {
	...
	m.DeleteForPNMock.callArgs = []*RecordCleanerMockDeleteForPNParams{}
...
type mRecordCleanerMockDeleteForPN struct {
	...
	defaultExpectation *RecordCleanerMockDeleteForPNExpectation
	expectations       []*RecordCleanerMockDeleteForPNExpectation

	callArgs []*RecordCleanerMockDeleteForPNParams
	mutex    sync.RWMutex
}
...
type RecordCleanerMockDeleteForPNExpectation struct {
	mock   *RecordCleanerMock
	params *RecordCleanerMockDeleteForPNParams
...
// Expect sets up expected params for RecordCleaner.DeleteForPN
func (mmDeleteForPN *mRecordCleanerMockDeleteForPN) Expect(ctx context.Context, pulse insolar.PulseNumber) *mRecordCleanerMockDeleteForPN {
	if mmDeleteForPN.mock.funcDeleteForPN != nil {
		mmDeleteForPN.mock.t.Fatalf("RecordCleanerMock.DeleteForPN mock is already set by Set")
	}

	if mmDeleteForPN.defaultExpectation == nil {
		mmDeleteForPN.defaultExpectation = &RecordCleanerMockDeleteForPNExpectation{}
	}

	mmDeleteForPN.defaultExpectation.params = &RecordCleanerMockDeleteForPNParams{ctx, pulse}
...
// Inspect accepts an inspector function that has same arguments as the RecordCleaner.DeleteForPN
func (mmDeleteForPN *mRecordCleanerMockDeleteForPN) Inspect(f func(ctx context.Context, pulse insolar.PulseNumber)) *mRecordCleanerMockDeleteForPN {
	if mmDeleteForPN.mock.inspectFuncDeleteForPN != nil {
		mmDeleteForPN.mock.t.Fatalf("Inspect function is already set for RecordCleanerMock.DeleteForPN")
	}
...
// Return sets up results that will be returned by RecordCleaner.DeleteForPN
func (mmDeleteForPN *mRecordCleanerMockDeleteForPN) Return() *RecordCleanerMock {
	if mmDeleteForPN.mock.funcDeleteForPN != nil {
		mmDeleteForPN.mock.t.Fatalf("RecordCleanerMock.DeleteForPN mock is already set by Set")
	}

	if mmDeleteForPN.defaultExpectation == nil {
		mmDeleteForPN.defaultExpectation = &RecordCleanerMockDeleteForPNExpectation{mock: mmDeleteForPN.mock}
	}

	return mmDeleteForPN.mock
}

//Set uses given function f to mock the RecordCleaner.DeleteForPN method
func (mmDeleteForPN *mRecordCleanerMockDeleteForPN) Set(f func(ctx context.Context, pulse insolar.PulseNumber)) *RecordCleanerMock {
	if mmDeleteForPN.defaultExpectation != nil {
		mmDeleteForPN.mock.t.Fatalf("Default expectation is already set for the RecordCleaner.DeleteForPN method")
	}

	if len(mmDeleteForPN.expectations) > 0 {
		mmDeleteForPN.mock.t.Fatalf("Some expectations are already set for the RecordCleaner.DeleteForPN method")
	}
...
func (mmDeleteForPN *RecordCleanerMock) DeleteForPN(ctx context.Context, pulse insolar.PulseNumber) {
	...
	mm_params := &RecordCleanerMockDeleteForPNParams{ctx, pulse}
	...
	if mmDeleteForPN.DeleteForPNMock.defaultExpectation != nil {
		...
		mm_got := RecordCleanerMockDeleteForPNParams{ctx, pulse}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmDeleteForPN.t.Errorf("RecordCleanerMock.DeleteForPN got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
	...
	mmDeleteForPN.t.Fatalf("Unexpected call to RecordCleanerMock.DeleteForPN. %v %v", ctx, pulse)
...
// Calls returns a list of arguments used in each call to RecordCleanerMock.DeleteForPN.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmDeleteForPN *mRecordCleanerMockDeleteForPN) Calls() []*RecordCleanerMockDeleteForPNParams {
	mmDeleteForPN.mutex.RLock()

	argCopy := make([]*RecordCleanerMockDeleteForPNParams, len(mmDeleteForPN.callArgs))
...
func (m *RecordCleanerMock) MinimockDeleteForPNInspect() {
	for _, e := range m.DeleteForPNMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RecordCleanerMock.DeleteForPN with params: %#v", *e.params)
		}
	}
	...
	if m.DeleteForPNMock.defaultExpectation != nil && mm_atomic.LoadUint64(&m.afterDeleteForPNCounter) < 1 {
		if m.DeleteForPNMock.defaultExpectation.params == nil {
			...
			m.t.Errorf("Expected call to RecordCleanerMock.DeleteForPN with params: %#v", *m.DeleteForPNMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcDeleteForPN != nil && mm_atomic.LoadUint64(&m.afterDeleteForPNCounter) < 1 {
...
func (m *RecordCleanerMock) minimockDone() bool {
	done := true
	return done &&
