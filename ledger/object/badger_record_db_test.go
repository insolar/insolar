...
func TestRecordKeyBadger(t *testing.T) {
	t.Parallel()
...
func TestRecordPositionKeyBadger(t *testing.T) {
	t.Parallel()
...
func TestBadgerLastKnownRecordPositionKey(t *testing.T) {
	t.Parallel()
...
func TestBadgerRecordStorage_TruncateHead(t *testing.T) {
	t.Parallel()
	...
	recordStore := NewBadgerRecordDB(dbMock)
...
func TestBadgerRecordStorage_NewStorageMemory(t *testing.T) {
	t.Parallel()
...
func TestBadgerRecordStorage_ForID(t *testing.T) {
	t.Parallel()
...
func TestBadgerRecordStorage_Set(t *testing.T) {
	t.Parallel()
...
func TestBadgerRecordStorage_DB_Set(t *testing.T) {
	t.Parallel()
...
func TestBadgerRecordStorage_Delete(t *testing.T) {
	t.Parallel()
...
func TestBadgerRecordStorage_ForPulse(t *testing.T) {
	t.Parallel()
...
func TestBadgerRecordPositionDB(t *testing.T) {
	t.Parallel()
