...
func (m *msenderMockCreateParcel) Return(r core.Parcel, r1 error) *senderMock {
	m.mock.CreateParcelFunc = func(p context.Context, p1 core.Message, p2 core.DelegationToken, p3 core.Pulse) (core.Parcel, error) {
		return r, r1
	}
	return m.mock
}
...
func (m *msenderMockNewRecorder) Expect(p context.Context, p1 core.Pulse) *msenderMockNewRecorder {
	m.mockExpectations = &senderMockNewRecorderParams{p, p1}
	return m
}
...
func (m *msenderMockNewRecorder) Return(r core.MessageBus, r1 error) *senderMock {
	m.mock.NewRecorderFunc = func(p context.Context, p1 core.Pulse) (core.MessageBus, error) {
		return r, r1
	}
	return m.mock
}
...
func (m *senderMock) NewRecorder(p context.Context, p1 core.Pulse) (r core.MessageBus, r1 error) {
	...
	if m.NewRecorderMock.mockExpectations != nil {
		testify_assert.Equal(m.t, *m.NewRecorderMock.mockExpectations, senderMockNewRecorderParams{p, p1},
...
func (m *msenderMockSend) Expect(p context.Context, p1 core.Message, p2 core.Pulse, p3 *core.MessageSendOptions) *msenderMockSend {
	m.mockExpectations = &senderMockSendParams{p, p1, p2, p3}
	return m
}
...
func (m *msenderMockSend) Return(r core.Reply, r1 error) *senderMock {
	m.mock.SendFunc = func(p context.Context, p1 core.Message, p2 core.Pulse, p3 *core.MessageSendOptions) (core.Reply, error) {
		return r, r1
	}
	return m.mock
}
...
func (m *senderMock) Send(p context.Context, p1 core.Message, p2 core.Pulse, p3 *core.MessageSendOptions) (r core.Reply, r1 error) {
	...
	if m.SendMock.mockExpectations != nil {
		testify_assert.Equal(m.t, *m.SendMock.mockExpectations, senderMockSendParams{p, p1, p2, p3},
...
func (m *msenderMockSendParcel) Expect(p context.Context, p1 core.Parcel, p2 core.Pulse, p3 *core.MessageSendOptions) *msenderMockSendParcel {
	m.mockExpectations = &senderMockSendParcelParams{p, p1, p2, p3}
	return m
}
...
func (m *msenderMockSendParcel) Return(r core.Reply, r1 error) *senderMock {
	m.mock.SendParcelFunc = func(p context.Context, p1 core.Parcel, p2 core.Pulse, p3 *core.MessageSendOptions) (core.Reply, error) {
		return r, r1
	}
	return m.mock
}
...
func (m *senderMock) SendParcel(p context.Context, p1 core.Parcel, p2 core.Pulse, p3 *core.MessageSendOptions) (r core.Reply, r1 error) {
	...
	if m.SendParcelMock.mockExpectations != nil {
		testify_assert.Equal(m.t, *m.SendParcelMock.mockExpectations, senderMockSendParcelParams{p, p1, p2, p3},
