...
//go:generate minimock -i github.com/insolar/insolar/longbits.FixedReader -o . -s _mock_test.go -g
...
//go:generate minimock -i github.com/insolar/insolar/longbits.FoldableReader -o . -s _mock_test.go -g
