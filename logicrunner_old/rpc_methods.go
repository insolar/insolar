...
// 	event := sm_execute_request.NewRPCBuilder(req.Request, req.Callee).
// 		GetCode(req.Code)
...
// 	}
//
// 	m.conveyor.AddInput(ctx, )
//
// 	result, ok := m.matcher.Wait(id)
// 	if !ok {
// 		return errors.New("failed to wait for response")
// 	}
// 	if err, ok := result.(error); ok {
// 		return err
// 	}
// 	rep.Code = result.([]byte)
// 	return nil
// }
//
