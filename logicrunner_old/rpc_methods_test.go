...
// 	"github.com/insolar/insolar/logicrunner_old"
...
// 	// 	logicrunner_old.NewOutgoingRequestSenderMock(t),
// 	// )
// 	require.NotNil(t, m)
// }
//
...
// 			name: "success",
// 			transcript: &common.Transcript{
// 				Request: logicrunner_old.genIncomingRequest(),
// 			},
...
// 	as := system.New()
// 	os := logicrunner_old.NewOutgoingRequestSender(as, cr, am, pa)
//
...
// 	os := logicrunner_old.NewOutgoingRequestSenderMock(t)
//
