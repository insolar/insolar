...
func TestTransferMoney(t *testing.T) {
	...
	_, err := signedRequest(firstMember, "member.transfer", map[string]interface{}{"amount": amountStr, "toMemberReference": secondMember.ref})
...
func TestTransferMoneyToNotExist(t *testing.T) {
	...
	_, err := signedRequest(firstMember, "member.transfer", map[string]interface{}{"amount": amount, "toMemberReference": gen.Reference().String()})
	require.Error(t, err)
	require.Contains(t, err.Error(), "index not found")
