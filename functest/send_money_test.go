...
func checkBalanceFewTimes(t *testing.T, caller *user, ref string, expected big.Int) {
	for i := 0; i < times; i++ {
		balance, _ := getBalanceNoErr(t, caller, ref)
...
func TestTransferMoney(t *testing.T) {
	...
	secondMember := contractCreateMember(t)
...
func TestTransferMoneyFromNotExist(t *testing.T) {
	...
	secondMember := contractCreateMember(t)
	oldSecondBalance, _ := getBalanceNoErr(t, secondMember, secondMember.ref)
	...
	newSecondBalance, _ := getBalanceNoErr(t, secondMember, secondMember.ref)
	require.Equal(t, oldSecondBalance, newSecondBalance)
}

func TestTransferMoneyToNotExist(t *testing.T) {
	firstMember := contractCreateMember(t)
	oldFirstBalance, _ := getBalanceNoErr(t, firstMember, firstMember.ref)
	...
	newFirstBalance, _ := getBalanceNoErr(t, firstMember, firstMember.ref)
...
func TestTransferToMyself(t *testing.T) {
	...
	oldMemberBalance, _ := getBalanceNoErr(t, member, member.ref)
	...
	newMemberBalance, _ := getBalanceNoErr(t, member, member.ref)
