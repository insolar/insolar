...
type NetworkCommonFacade interface {
	...
	SetConsensus(insolarConsensus consensus.ConsensusProcessor)
	GetConsensus() consensus.ConsensusProcessor
}
...
type commonFacade struct {
	...
	ic      consensus.ConsensusProcessor
}
...
func (fac *commonFacade) SetConsensus(insolarConsensus consensus.ConsensusProcessor) {
	fac.ic = insolarConsensus
}

func (fac *commonFacade) GetConsensus() consensus.ConsensusProcessor {
	return fac.ic
}
