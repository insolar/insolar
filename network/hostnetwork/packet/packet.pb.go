...
type PrimaryRole int32

const (
	Inactive      PrimaryRole = 0
	Neutral       PrimaryRole = 1
	HeavyMaterial PrimaryRole = 2
	LightMaterial PrimaryRole = 3
	Virtual       PrimaryRole = 4
)

var PrimaryRole_name = map[int32]string{
	0: "Inactive",
	1: "Neutral",
	2: "HeavyMaterial",
	3: "LightMaterial",
...
var PrimaryRole_value = map[string]int32{
	"Inactive":      0,
	"Neutral":       1,
	"HeavyMaterial": 2,
	"LightMaterial": 3,
...
func (PrimaryRole) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c3f826366adfd81c, []int{0}
}

type SpecialRole int32

const (
	None      SpecialRole = 0
	Discovery SpecialRole = 1
)

var SpecialRole_name = map[int32]string{
	0: "None",
	1: "Discovery",
}

var SpecialRole_value = map[string]int32{
	"None":      0,
	"Discovery": 1,
}

func (SpecialRole) EnumDescriptor() ([]byte, []int) {
...
type CandidateProfile struct {
	...
	ShortID     uint32                                       `protobuf:"varint,3,opt,name=ShortID,proto3" json:"ShortID,omitempty"`
	PrimaryRole PrimaryRole                                  `protobuf:"varint,4,opt,name=PrimaryRole,proto3,enum=packet.PrimaryRole" json:"PrimaryRole,omitempty"`
	SpecialRole SpecialRole                                  `protobuf:"varint,5,opt,name=SpecialRole,proto3,enum=packet.SpecialRole" json:"SpecialRole,omitempty"`
...
func (m *CandidateProfile) Reset()      { *m = CandidateProfile{} }
func (*CandidateProfile) ProtoMessage() {}
func (*CandidateProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_c3f826366adfd81c, []int{10}
}
func (m *CandidateProfile) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CandidateProfile) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CandidateProfile.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *CandidateProfile) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CandidateProfile.Merge(m, src)
}
func (m *CandidateProfile) XXX_Size() int {
	return m.Size()
}
func (m *CandidateProfile) XXX_DiscardUnknown() {
	xxx_messageInfo_CandidateProfile.DiscardUnknown(m)
}

var xxx_messageInfo_CandidateProfile proto.InternalMessageInfo

type BootstrapRequest struct {
	CandidateProfile CandidateProfile `protobuf:"bytes,2,opt,name=CandidateProfile,proto3" json:"CandidateProfile"`
...
func (*ReconnectResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c3f826366adfd81c, []int{24}
}
...
func init() {
	proto.RegisterEnum("packet.PrimaryRole", PrimaryRole_name, PrimaryRole_value)
	proto.RegisterEnum("packet.SpecialRole", SpecialRole_name, SpecialRole_value)
	...
	proto.RegisterType((*CandidateProfile)(nil), "packet.CandidateProfile")
...
var fileDescriptor_c3f826366adfd81c = []byte{
	...
	,
}

func (x PrimaryRole) String() string {
	s, ok := PrimaryRole_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
}
func (x SpecialRole) String() string {
	s, ok := SpecialRole_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *CandidateProfile) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CandidateProfile)
	if !ok {
		that2, ok := that.(CandidateProfile)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.PrimaryRole != that1.PrimaryRole {
		return false
	}
	if this.SpecialRole != that1.SpecialRole {
		return false
	}
...
func (this *CandidateProfile) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 12)
	s = append(s, "&packet.CandidateProfile{")
...
func (m *CandidateProfile) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CandidateProfile) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintPacket(dAtA, i, uint64(m.Ref.Size()))
	n33, err := m.Ref.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n33
	if m.ShortID != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintPacket(dAtA, i, uint64(m.ShortID))
	}
	if m.PrimaryRole != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintPacket(dAtA, i, uint64(m.PrimaryRole))
	}
	if m.SpecialRole != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintPacket(dAtA, i, uint64(m.SpecialRole))
	}
	if len(m.Digest) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintPacket(dAtA, i, uint64(len(m.Digest)))
...
func (m *BootstrapRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n34, err := m.CandidateProfile.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n34
...
func (m *AuthorizeRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AuthorizeData != nil {
		...
		n37, err := m.AuthorizeData.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *SignCertRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	n38, err := m.NodeRef.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n38
...
func (m *Permit) MarshalTo(dAtA []byte) (int, error) {
	...
	n39, err := m.Payload.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n39
...
func (m *PermitPayload) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ReconnectTo != nil {
		...
		i++
		i = encodeVarintPacket(dAtA, i, uint64(m.ReconnectTo.Size()))
		n40, err := m.ReconnectTo.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
	...
	n41, err := m.AuthorityNodeRef.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n41
...
func (m *BootstrapResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintPacket(dAtA, i, uint64(m.Pulse.Size()))
	n42, err := m.Pulse.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n42
...
func (m *AuthorizeResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Permit != nil {
		...
		i++
		i = encodeVarintPacket(dAtA, i, uint64(m.Permit.Size()))
		n43, err := m.Permit.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
	...
	if m.Pulse != nil {
		...
		i++
		i = encodeVarintPacket(dAtA, i, uint64(m.Pulse.Size()))
		n44, err := m.Pulse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
...
func (m *CandidateProfile) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	n += 1 + l + sovPacket(uint64(l))
	if m.ShortID != 0 {
		n += 1 + sovPacket(uint64(m.ShortID))
	}
	if m.PrimaryRole != 0 {
		n += 1 + sovPacket(uint64(m.PrimaryRole))
	}
	if m.SpecialRole != 0 {
		n += 1 + sovPacket(uint64(m.SpecialRole))
	}
	l = len(m.Digest)
	if l > 0 {
		n += 1 + l + sovPacket(uint64(l))
...
func (this *CandidateProfile) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CandidateProfile{`,
...
func (this *BootstrapRequest) String() string {
	...
	s := strings.Join([]string{`&BootstrapRequest{`,
		`CandidateProfile:` + strings.Replace(strings.Replace(this.CandidateProfile.String(), "CandidateProfile", "CandidateProfile", 1), `&`, ``, 1) + `,`,
...
func (m *CandidateProfile) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CandidateProfile: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CandidateProfile: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
