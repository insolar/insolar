...
func (mmDigestData *DataSignerMock) DigestData(reader io.Reader) (d1 Digest) {
	...
	mmDigestData.DigestDataMock.callArgs = append(mmDigestData.DigestDataMock.callArgs, params)
	...
	if mmDigestData.DigestDataMock.defaultExpectation != nil {
		...
		want := mmDigestData.DigestDataMock.defaultExpectation.params
		got := DataSignerMockDigestDataParams{reader}
		if want != nil && !minimock.Equal(*want, got) {
			mmDigestData.t.Errorf("DataSignerMock.DigestData got unexpected parameters, want: %#v, got: %#v%s\n", *want, got, minimock.Diff(*want, got))
		}

		results := mmDigestData.DigestDataMock.defaultExpectation.results
		if results == nil {
...
func (mmGetDigestSize *DataSignerMock) GetDigestSize() (i1 int) {
	...
	if mmGetDigestSize.GetDigestSizeMock.defaultExpectation != nil {
		...
		results := mmGetDigestSize.GetDigestSizeMock.defaultExpectation.results
		if results == nil {
