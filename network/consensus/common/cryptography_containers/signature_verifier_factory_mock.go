...
The original interface "SignatureVerifierFactory" can be found in github.com/insolar/insolar/network/consensus/common/cryptography_containers
*/
import (
	"sync/atomic"
	"time"
...
//SignatureVerifierFactoryMock implements github.com/insolar/insolar/network/consensus/common/cryptography_containers.SignatureVerifierFactory
...
//NewSignatureVerifierFactoryMock returns a mock for github.com/insolar/insolar/network/consensus/common/cryptography_containers.SignatureVerifierFactory
...
//GetSignatureVerifierWithPKS implements github.com/insolar/insolar/network/consensus/common/cryptography_containers.SignatureVerifierFactory interface
