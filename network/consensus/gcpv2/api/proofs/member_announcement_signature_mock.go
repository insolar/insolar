...
The original interface "MemberAnnouncementSignature" can be found in github.com/insolar/insolar/network/consensus/gcpv2/api/proofs
*/
import (
	io "io"
	"sync/atomic"
...
//MemberAnnouncementSignatureMock implements github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.MemberAnnouncementSignature
type MemberAnnouncementSignatureMock struct {
	...
	CopyOfSignatureFunc       func() (r cryptkit.Signature)
	...
	EqualsFunc       func(p cryptkit.SignatureHolder) (r bool)
...
//NewMemberAnnouncementSignatureMock returns a mock for github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.MemberAnnouncementSignature
...
//AsByteString implements github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.MemberAnnouncementSignature interface
...
//AsBytes implements github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.MemberAnnouncementSignature interface
...
func (m *mMemberAnnouncementSignatureMockCopyOfSignature) Return(r cryptkit.Signature) *MemberAnnouncementSignatureMock {
	m.mock.CopyOfSignatureFunc = nil
	m.expectationSeries = nil
...
func (e *MemberAnnouncementSignatureMockCopyOfSignatureExpectation) Return(r cryptkit.Signature) {
...
//CopyOfSignature implements github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.MemberAnnouncementSignature interface
func (m *MemberAnnouncementSignatureMock) CopyOfSignature() (r cryptkit.Signature) {
...
func (m *mMemberAnnouncementSignatureMockEquals) Expect(p cryptkit.SignatureHolder) *mMemberAnnouncementSignatureMockEquals {
...
func (m *mMemberAnnouncementSignatureMockEquals) ExpectOnce(p cryptkit.SignatureHolder) *MemberAnnouncementSignatureMockEqualsExpectation {
	m.mock.EqualsFunc = nil
	m.mainExpectation = nil
...
//Equals implements github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.MemberAnnouncementSignature interface
func (m *MemberAnnouncementSignatureMock) Equals(p cryptkit.SignatureHolder) (r bool) {
...
//FixedByteSize implements github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.MemberAnnouncementSignature interface
...
//FoldToUint64 implements github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.MemberAnnouncementSignature interface
...
func (m *mMemberAnnouncementSignatureMockGetSignatureMethod) Return(r cryptkit.SignatureMethod) *MemberAnnouncementSignatureMock {
	m.mock.GetSignatureMethodFunc = nil
	m.expectationSeries = nil
...
func (e *MemberAnnouncementSignatureMockGetSignatureMethodExpectation) Return(r cryptkit.SignatureMethod) {
...
func (m *mMemberAnnouncementSignatureMockGetSignatureMethod) Set(f func() (r cryptkit.SignatureMethod)) *MemberAnnouncementSignatureMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
//GetSignatureMethod implements github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.MemberAnnouncementSignature interface
func (m *MemberAnnouncementSignatureMock) GetSignatureMethod() (r cryptkit.SignatureMethod) {
...
//Read implements github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.MemberAnnouncementSignature interface
...
//WriteTo implements github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.MemberAnnouncementSignature interface
