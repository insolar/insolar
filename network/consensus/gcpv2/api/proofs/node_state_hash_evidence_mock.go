...
type NodeStateHashEvidenceMock struct {
	...
	GetGlobulaNodeStateSignatureFunc       func() (r cryptkit.SignatureHolder)
...
func (m *mNodeStateHashEvidenceMockGetGlobulaNodeStateSignature) Return(r cryptkit.SignatureHolder) *NodeStateHashEvidenceMock {
	m.mock.GetGlobulaNodeStateSignatureFunc = nil
	m.expectationSeries = nil
...
func (e *NodeStateHashEvidenceMockGetGlobulaNodeStateSignatureExpectation) Return(r cryptkit.SignatureHolder) {
...
func (m *mNodeStateHashEvidenceMockGetGlobulaNodeStateSignature) Set(f func() (r cryptkit.SignatureHolder)) *NodeStateHashEvidenceMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
//GetGlobulaNodeStateSignature implements github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.NodeStateHashEvidence interface
func (m *NodeStateHashEvidenceMock) GetGlobulaNodeStateSignature() (r cryptkit.SignatureHolder) {
...
//GetNodeStateHash implements github.com/insolar/insolar/network/consensus/gcpv2/api/proofs.NodeStateHashEvidence interface
