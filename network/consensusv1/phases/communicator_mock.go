...
The original interface "Communicator" can be found in github.com/insolar/insolar/network/consensusv1/phases
*/
import (
	context "context"
	"sync/atomic"
...
//CommunicatorMock implements github.com/insolar/insolar/network/consensusv1/phases.Communicator
type CommunicatorMock struct {
	...
	ExchangePhase2Func       func(p context.Context, p1 *ConsensusState, p2 []insolar.NetworkNode, p3 *packets.Phase2Packet) (r map[insolar.Reference]*packets.Phase2Packet, r1 error)
	ExchangePhase2Counter    uint64
	ExchangePhase2PreCounter uint64
	ExchangePhase2Mock       mCommunicatorMockExchangePhase2

	ExchangePhase21Func       func(p context.Context, p1 *ConsensusState, p2 *packets.Phase2Packet, p3 []*AdditionalRequest) (r []packets.ReferendumVote, r1 error)
...
//NewCommunicatorMock returns a mock for github.com/insolar/insolar/network/consensusv1/phases.Communicator
...
func (m *mCommunicatorMockExchangePhase1) Expect(p context.Context, p1 *packets.NodeAnnounceClaim, p2 []insolar.NetworkNode, p3 *packets.Phase1Packet) *mCommunicatorMockExchangePhase1 {
...
func (m *mCommunicatorMockExchangePhase1) ExpectOnce(p context.Context, p1 *packets.NodeAnnounceClaim, p2 []insolar.NetworkNode, p3 *packets.Phase1Packet) *CommunicatorMockExchangePhase1Expectation {
	m.mock.ExchangePhase1Func = nil
...
//ExchangePhase1 implements github.com/insolar/insolar/network/consensusv1/phases.Communicator interface
...
func (m *mCommunicatorMockExchangePhase2) Expect(p context.Context, p1 *ConsensusState, p2 []insolar.NetworkNode, p3 *packets.Phase2Packet) *mCommunicatorMockExchangePhase2 {
...
func (m *mCommunicatorMockExchangePhase2) ExpectOnce(p context.Context, p1 *ConsensusState, p2 []insolar.NetworkNode, p3 *packets.Phase2Packet) *CommunicatorMockExchangePhase2Expectation {
	m.mock.ExchangePhase2Func = nil
	m.mainExpectation = nil
...
func (m *mCommunicatorMockExchangePhase2) Set(f func(p context.Context, p1 *ConsensusState, p2 []insolar.NetworkNode, p3 *packets.Phase2Packet) (r map[insolar.Reference]*packets.Phase2Packet, r1 error)) *CommunicatorMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
//ExchangePhase2 implements github.com/insolar/insolar/network/consensusv1/phases.Communicator interface
...
func (m *mCommunicatorMockExchangePhase21) Expect(p context.Context, p1 *ConsensusState, p2 *packets.Phase2Packet, p3 []*AdditionalRequest) *mCommunicatorMockExchangePhase21 {
...
func (m *mCommunicatorMockExchangePhase21) ExpectOnce(p context.Context, p1 *ConsensusState, p2 *packets.Phase2Packet, p3 []*AdditionalRequest) *CommunicatorMockExchangePhase21Expectation {
	m.mock.ExchangePhase21Func = nil
	m.mainExpectation = nil
...
func (m *mCommunicatorMockExchangePhase21) Set(f func(p context.Context, p1 *ConsensusState, p2 *packets.Phase2Packet, p3 []*AdditionalRequest) (r []packets.ReferendumVote, r1 error)) *CommunicatorMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
//ExchangePhase21 implements github.com/insolar/insolar/network/consensusv1/phases.Communicator interface
...
func (m *mCommunicatorMockExchangePhase3) Expect(p context.Context, p1 []insolar.NetworkNode, p2 *packets.Phase3Packet) *mCommunicatorMockExchangePhase3 {
...
func (m *mCommunicatorMockExchangePhase3) ExpectOnce(p context.Context, p1 []insolar.NetworkNode, p2 *packets.Phase3Packet) *CommunicatorMockExchangePhase3Expectation {
	m.mock.ExchangePhase3Func = nil
	m.mainExpectation = nil
...
//ExchangePhase3 implements github.com/insolar/insolar/network/consensusv1/phases.Communicator interface
...
//Init implements github.com/insolar/insolar/network/consensusv1/phases.Communicator interface
