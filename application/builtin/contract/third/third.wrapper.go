...
func INSMETHOD_GetSagaCallsNum(object []byte, data []byte) (newState []byte, result []byte, err error) {
	ph := common.CurrentProxyCtx
	ph.SetSystemError(nil)
	...
	if len(object) == 0 {
		err = &foundation.Error{S: "[ FakeGetSagaCallsNum ] ( INSMETHOD_* ) ( Generated Method ) Object is nil"}
		return
	}

	err = ph.Deserialize(object, self)
	if err != nil {
		err = &foundation.Error{S: "[ FakeGetSagaCallsNum ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Data: " + err.Error()}
		return
	}
	...
	err = ph.Deserialize(data, &args)
	if err != nil {
		err = &foundation.Error{S: "[ FakeGetSagaCallsNum ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Arguments: " + err.Error()}
		return
	}
	...
	ret0, ret1 = self.GetSagaCallsNum()
...
func Initialize() insolar.ContractWrapper {
	return insolar.ContractWrapper{
		...
		Methods: insolar.ContractMethods{
			...
			"GetSagaCallsNum": INSMETHOD_GetSagaCallsNum,
