...
var PrototypeReference, _ = insolar.NewObjectReferenceFromString("insolar:0AAABAvLHxTrJlTh1shE1BVu7eqMP_EDselTYmNK62Vk")

// Third holds proxy type
type Third struct {
...
func (r *ContractConstructorHolder) AsChild(objRef insolar.Reference) (*Third, error) {
	...
	return &Third{Reference: ref}, nil
}

// GetObject returns proxy object
func GetObject(ref insolar.Reference) *Third {
	if !ref.IsObjectReference() {
		return nil
	}
	return &Third{Reference: ref}
}
...
func (r *Third) GetReference() insolar.Reference {
	return r.Reference
}

// GetPrototype returns reference to the code
func (r *Third) GetPrototype() (insolar.Reference, error) {
...
func (r *Third) GetCode() (insolar.Reference, error) {
	if r.Code.IsEmpty() {
		ret := [2]interface{}{}
		var ret0 insolar.Reference
		ret[0] = &ret0
...
func (r *Third) GetName() (string, error) {
	var args [0]interface{}
...
func (r *Third) GetNameAsImmutable() (string, error) {
	var args [0]interface{}
...
func (r *Third) Transfer(delta int) error {
...
func (r *Third) TransferAsImmutable(delta int) error {
	var args [1]interface{}
	args[0] = delta
...
func (r *Third) GetSagaCallsNum() (int, error) {
	var args [0]interface{}
...
func (r *Third) GetSagaCallsNumAsImmutable() (int, error) {
	var args [0]interface{}
...
func (r *Third) Accept(delta int) error {
	var args [1]interface{}
	args[0] = delta
...
func (r *Third) DoNothingAsImmutable() error {
	var args [0]interface{}
