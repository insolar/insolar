...
import (
	first "github.com/insolar/insolar/application/builtin/proxy/second"
...
var PrototypeReference, _ = insolar.NewObjectReferenceFromString("insolar:0AAABAj3jM5sfvcae04nQM7905epERQz-aKrbozrGt6o")
...
func (r *One) TestPayload() (first.Payload, error) {
	var args [0]interface{}

	var argsSerialized []byte

	ret := make([]interface{}, 2)
	var ret0 first.Payload
	ret[0] = &ret0
	var ret1 *foundation.Error
	ret[1] = &ret1
...
func (r *One) TestPayloadAsImmutable() (first.Payload, error) {
	var args [0]interface{}
