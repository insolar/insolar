...
var PrototypeReference, _ = insolar.NewObjectReferenceFromString("insolar:0AAABAp_fuF5yNmzdpjZfqOZ-ozBwBdPZRs24J9PVIgg")
...
func (r *First) DoNothingAsImmutable() error {
	var args [0]interface{}
...
func (r *First) GetAsImmutable() (int, error) {
	var args [0]interface{}
...
func (r *First) Hello(s string) (string, error) {
	var args [1]interface{}
	args[0] = s
...
func (r *First) HelloAsImmutable(s string) (string, error) {
	var args [1]interface{}
	args[0] = s
...
func (r *First) GetPayload() (Payload, error) {
	var args [0]interface{}
...
func (r *First) GetPayloadAsImmutable() (Payload, error) {
	var args [0]interface{}
...
func (r *First) SetPayload(P Payload) error {
	var args [1]interface{}
	args[0] = P
...
func (r *First) SetPayloadAsImmutable(P Payload) error {
	var args [1]interface{}
	args[0] = P
...
func (r *First) GetPayloadString() (string, error) {
	var args [0]interface{}
...
func (r *First) GetPayloadStringAsImmutable() (string, error) {
	var args [0]interface{}
...
func (r *First) GetBalance() (int, error) {
	var args [0]interface{}
...
func (r *First) GetBalanceAsImmutable() (int, error) {
	var args [0]interface{}
...
func (r *First) Accept(amount int) error {
	var args [1]interface{}
	args[0] = amount
...
func (r *First) AnErrorAsImmutable() error {
	var args [0]interface{}
...
func (r *First) NoErrorAsImmutable() error {
	var args [0]interface{}
...
func (r *First) ReturnNil() (*string, error) {
	var args [0]interface{}
...
func (r *First) ReturnNilAsImmutable() (*string, error) {
	var args [0]interface{}
