...
// ExternalCallDoNothing is proxy generated method
func (r *Second) ExternalCallDoNothing() error {
	...
	res, err := common.CurrentProxyCtx.RouteCall(r.Reference, false, false, "ExternalCallDoNothing", argsSerialized, *PrototypeReference)
	if err != nil {
		return err
	}
...
// ExternalCallDoNothingAsImmutable is proxy generated method
func (r *Second) ExternalCallDoNothingAsImmutable() error {
	var args [0]interface{}
	...
	res, err := common.CurrentProxyCtx.RouteCall(r.Reference, true, false, "ExternalCallDoNothing", argsSerialized, *PrototypeReference)
	if err != nil {
		return err
	}
...
// GetParent is proxy generated method
func (r *Second) GetParent() (string, error) {
	...
	res, err := common.CurrentProxyCtx.RouteCall(r.Reference, false, false, "GetParent", argsSerialized, *PrototypeReference)
	if err != nil {
		return ret0, err
	}
...
// GetParentAsImmutable is proxy generated method
func (r *Second) GetParentAsImmutable() (string, error) {
	var args [0]interface{}
	...
	res, err := common.CurrentProxyCtx.RouteCall(r.Reference, true, false, "GetParent", argsSerialized, *PrototypeReference)
	if err != nil {
		return ret0, err
	}
