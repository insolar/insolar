...
//go:generate minimock -i github.com/insolar/insolar/insolar.Conveyor -o ../testutils -s _mock.go
...
//go:generate minimock -i github.com/insolar/insolar/insolar.ConveyorFuture -o ../testutils -s _mock.go
