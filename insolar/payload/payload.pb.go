...
type SetIncomingRequest struct {
	Polymorph uint32                 `protobuf:"varint,16,opt,name=Polymorph,proto3" json:"Polymorph,omitempty"`
	Request   record.IncomingRequest `protobuf:"bytes,20,opt,name=Request,proto3" json:"Request"`
}
...
func (m *SetIncomingRequest) GetRequest() record.IncomingRequest {
	if m != nil {
		return m.Request
	}
...
type SetOutgoingRequest struct {
	Polymorph uint32                 `protobuf:"varint,16,opt,name=Polymorph,proto3" json:"Polymorph,omitempty"`
	Request   record.OutgoingRequest `protobuf:"bytes,20,opt,name=Request,proto3" json:"Request"`
}
...
func (m *SetOutgoingRequest) GetRequest() record.OutgoingRequest {
	if m != nil {
		return m.Request
	}
...
var fileDescriptor_33334fec96407f54 = []byte{
	...
	,
}
...
func (this *SetIncomingRequest) String() string {
	...
	s := strings.Join([]string{`&SetIncomingRequest{`,
		`Polymorph:` + fmt.Sprintf("%v", this.Polymorph) + `,`,
		`Request:` + strings.Replace(strings.Replace(this.Request.String(), "IncomingRequest", "record.IncomingRequest", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *SetOutgoingRequest) String() string {
	...
	s := strings.Join([]string{`&SetOutgoingRequest{`,
		`Polymorph:` + fmt.Sprintf("%v", this.Polymorph) + `,`,
		`Request:` + strings.Replace(strings.Replace(this.Request.String(), "OutgoingRequest", "record.OutgoingRequest", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
