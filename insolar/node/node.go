...
//go:generate minimock -i github.com/insolar/insolar/insolar/node.Accessor -o ./ -s _mock_test.go -g
...
//go:generate minimock -i github.com/insolar/insolar/insolar/node.Modifier -o ./ -s _mock_test.go -g
