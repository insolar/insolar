...
//go:generate minimock -i github.com/insolar/insolar/insolar/pulse.Accessor -o ./ -s _mock_test.go -g
...
//go:generate minimock -i github.com/insolar/insolar/insolar/pulse.Shifter -o ./ -s _mock_test.go -g
...
//go:generate minimock -i github.com/insolar/insolar/insolar/pulse.Appender -o ./ -s _mock_test.go -g
...
//go:generate minimock -i github.com/insolar/insolar/insolar/pulse.Calculator -o ./ -s _mock_test.go -g
