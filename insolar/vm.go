...
//go:generate minimock -i github.com/insolar/insolar/insolar.MachineLogicExecutor -o ../testutils -s _mock_test.go -g
...
//go:generate minimock -i github.com/insolar/insolar/insolar.LogicRunner -o ../testutils -s _mock_test.go -g
