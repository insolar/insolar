...
//go:generate minimock -i github.com/insolar/insolar/insolar/store.JetIndexModifier -o ./ -s _mock_test.go -g -g
...
//go:generate minimock -i github.com/insolar/insolar/insolar/store.JetIndexAccessor -o ./ -s _mock_test.go -g
