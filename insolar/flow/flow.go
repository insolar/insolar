...
//go:generate minimock -i github.com/insolar/insolar/insolar/flow.Procedure -o . -s _mock_test.go -g
...
//go:generate minimock -i github.com/insolar/insolar/insolar/flow.Flow -o . -s _mock_test.go -g
