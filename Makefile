...
.PHONY: ci_test_unit
ci_test_unit:
	CGO_ENABLED=1 go test $(TEST_ARGS) -v $(ALL_PACKAGES) -race -count 3 | tee unit.file
...
generate-protobuf:
	...
	protoc -I./vendor -I./ --gogoslick_out=./ --proto_path=${GOPATH}/src ledger/object/indexbucket.proto
