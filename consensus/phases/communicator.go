...
type Communicator interface {
	...
	ExchangeData(ctx context.Context, participants []core.Node, pulseData packets.PulseData, packet packets.Phase1Packet) (map[core.RecordRef]data.Phase1Packet, error)
}
...
func (nc *NaiveCommunicator) ExchangeData(ctx context.Context, participants []core.Node, pulseData packets.PulseData, packet data.Phase1Packet) (map[core.RecordRef]data.Phase1Packet, error) {
	panic("implement me")
}
