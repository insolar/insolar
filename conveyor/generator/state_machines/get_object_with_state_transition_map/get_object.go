...
func Register() {
	gen.AddMachine("GetObjectStateMachine").
		RegisterTransitionsMap(
			InitState,					gen.Available{WaitingPresent, CheckingJet},
			WaitingPresent,				gen.Available{CheckingJet},
			CheckingJet,				gen.Available{WaitingCheckingJet},
			WaitingCheckingJet,			gen.Available{FetchingJet, InvokeWaitingHotData},
			FetchingJet,				gen.Available{WaitingFetchingJet},
			WaitingFetchingJet,			gen.Available{InvokeWaitingHotData},
			InvokeWaitingHotData,		gen.Available{WaitingHotData},
			WaitingHotData,				gen.Available{CheckingIndex},
			CheckingIndex,				gen.Available{WaitingCheckingIndex},
			WaitingCheckingIndex,		gen.Available{CheckingState, FetchingIndex},
			FetchingIndex,				gen.Available{WaitingFetchingIndex},
			WaitingFetchingIndex,		gen.Available{CheckingState},
			CheckingState,				gen.Available{WaitingCheckingState},
			WaitingCheckingState,		gen.Available{Result, CheckingJetForState},
			CheckingJetForState,		gen.Available{WaitingCheckingJetForState},
			WaitingCheckingJetForState,	gen.Available{FetchingState, FetchingJetForState},
			FetchingJetForState,		gen.Available{WaitingFetchingJetForState},
			WaitingFetchingJetForState,	gen.Available{FetchingState},
			FetchingState,				gen.Available{WaitingFetchingState},
			WaitingFetchingState,		gen.Available{Result},
		).
