...
//ContractRequesterMockCallContractParams represents input parameters of the ContractRequester.CallMethod
...
//CallContractMinimockPreCounter returns the value of ContractRequesterMock.CallMethod invocations
