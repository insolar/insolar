...
type PulseTrackerMock struct {
	...
	GetLatestPulseFunc       func(p context.Context) (r *storage.Pulse, r1 error)
	GetLatestPulseCounter    uint64
	GetLatestPulsePreCounter uint64
	GetLatestPulseMock       mPulseTrackerMockGetLatestPulse

	GetPreviousPulseFunc       func(p context.Context, p1 core.PulseNumber) (r *storage.Pulse, r1 error)
	GetPreviousPulseCounter    uint64
	GetPreviousPulsePreCounter uint64
	GetPreviousPulseMock       mPulseTrackerMockGetPreviousPulse

	GetPulseFunc       func(p context.Context, p1 core.PulseNumber) (r *storage.Pulse, r1 error)
...
func (e *PulseTrackerMockGetLatestPulseExpectation) Return(r *storage.Pulse, r1 error) {
...
func (e *PulseTrackerMockGetPreviousPulseExpectation) Return(r *storage.Pulse, r1 error) {
...
func (e *PulseTrackerMockGetPulseExpectation) Return(r *storage.Pulse, r1 error) {
