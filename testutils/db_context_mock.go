...
type DBContextMock struct {
	...
	BeginTransactionFunc       func(p bool) (r *storage.TransactionManager, r1 error)
	...
	UpdateFunc       func(p context.Context, p1 func(p *storage.TransactionManager) (r error)) (r error)
	UpdateCounter    uint64
	UpdatePreCounter uint64
	UpdateMock       mDBContextMockUpdate

	ViewFunc       func(p context.Context, p1 func(p *storage.TransactionManager) (r error)) (r error)
	ViewCounter    uint64
...
func (e *DBContextMockBeginTransactionExpectation) Return(r *storage.TransactionManager, r1 error) {
...
type DBContextMockUpdateInput struct {
	p  context.Context
	p1 func(p *storage.TransactionManager) (r error)
}
