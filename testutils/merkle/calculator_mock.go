...
type CalculatorMock struct {
	...
	IsValidFunc       func(p merkle.Proof, p1 merkle.OriginHash, p2 keys.PublicKey) (r bool)
...
func (m *mCalculatorMockIsValid) Expect(p merkle.Proof, p1 merkle.OriginHash, p2 keys.PublicKey) *mCalculatorMockIsValid {
...
func (m *mCalculatorMockIsValid) ExpectOnce(p merkle.Proof, p1 merkle.OriginHash, p2 keys.PublicKey) *CalculatorMockIsValidExpectation {
	m.mock.IsValidFunc = nil
	m.mainExpectation = nil
...
func (m *mCalculatorMockIsValid) Set(f func(p merkle.Proof, p1 merkle.OriginHash, p2 keys.PublicKey) (r bool)) *CalculatorMock {
	m.mainExpectation = nil
	m.expectationSeries = nil
...
func (m *CalculatorMock) IsValid(p merkle.Proof, p1 merkle.OriginHash, p2 keys.PublicKey) (r bool) {
