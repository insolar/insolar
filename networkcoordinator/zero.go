...
func (znc *zeroNetworkCoordinator) signCert(ctx context.Context, nodeRef core.RecordRef) (core.Certificate, error) {
	return nil, errors.New("signCert is not allowed in Zero Network")
}
