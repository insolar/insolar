...
// AddNewMemberToMap is proxy generated method
func (r *RootDomain) AddNewMemberToMapAsMutable(publicKey string, memberRef insolar.Reference) error {
	...
	res, err := common.CurrentProxyCtx.RouteCall(r.Reference, true, false, false, "AddNewMemberToMap", argsSerialized, *PrototypeReference)
	if err != nil {
		return err
	}
...
// AddNewMemberToMapNoWait is proxy generated method
func (r *RootDomain) AddNewMemberToMapNoWait(publicKey string, memberRef insolar.Reference) error {
	var args [2]interface{}
	args[0] = publicKey
	args[1] = memberRef
	...
	_, err = common.CurrentProxyCtx.RouteCall(r.Reference, false, false, false, "AddNewMemberToMap", argsSerialized, *PrototypeReference)
	if err != nil {
		return err
	}
...
// AddNewMemberToMapAsImmutable is proxy generated method
func (r *RootDomain) AddNewMemberToMap(publicKey string, memberRef insolar.Reference) error {
	var args [2]interface{}
	args[0] = publicKey
	args[1] = memberRef
	...
	res, err := common.CurrentProxyCtx.RouteCall(r.Reference, true, true, false, "AddNewMemberToMap", argsSerialized, *PrototypeReference)
	if err != nil {
		return err
	}
