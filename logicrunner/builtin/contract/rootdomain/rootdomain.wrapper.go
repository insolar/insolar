...
func INSMETHOD_GetActiveMigrationDaemonMembers(object []byte, data []byte) ([]byte, []byte, error) {
	...
	if len(object) == 0 {
		return nil, nil, &foundation.Error{S: "[ FakeGetActiveMigrationDaemonMembers ] ( INSMETHOD_* ) ( Generated Method ) Object is nil"}
	}

	err := ph.Deserialize(object, self)
	if err != nil {
		e := &foundation.Error{S: "[ FakeGetActiveMigrationDaemonMembers ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Data: " + err.Error()}
		return nil, nil, e
	}
	...
	if err != nil {
		e := &foundation.Error{S: "[ FakeGetActiveMigrationDaemonMembers ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Arguments: " + err.Error()}
		return nil, nil, e
	}
