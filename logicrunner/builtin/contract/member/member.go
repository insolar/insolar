...
func (m *Member) getBalanceCall(params map[string]interface{}) (interface{}, error) {
	...
	reference, err := insolar.NewSelfScopeObjectReferenceFromBase58(referenceStr)
	if err != nil {
...
func (m *Member) transferCall(params map[string]interface{}) (interface{}, error) {
	...
	recipientReference, err := insolar.NewSelfScopeObjectReferenceFromBase58(recipientReferenceStr)
	if err != nil {
