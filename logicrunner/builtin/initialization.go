...
func InitializeCodeRefs() map[XXX_insolar.Reference]string {
	...
	rv[shouldLoadRef("111A7748JQuyE1ARrnWpTdY44pe5k1jss62udfTGk8v.1tJD1hMFxYYt9rHcYuvCMLdCn4AZdPfy4HPaavNWn8")] = "shard"
...
func InitializeCodeDescriptors() []XXX_artifacts.CodeDescriptor {
	...
	rv = append(rv, XXX_artifacts.NewCodeDescriptor(
		/* code:        */ nil,
		/* machineType: */ XXX_insolar.MachineTypeBuiltin,
		/* ref:         */ shouldLoadRef("111A7748JQuyE1ARrnWpTdY44pe5k1jss62udfTGk8v.1tJD1hMFxYYt9rHcYuvCMLdCn4AZdPfy4HPaavNWn8"),
	))
	// tariff
	rv = append(rv, XXX_artifacts.NewCodeDescriptor(
		/* code:        */ nil,
...
func InitializePrototypeDescriptors() []XXX_artifacts.ObjectDescriptor {
	...
	{ // shard
		pRef := shouldLoadRef("111A66c9Fu7cGTMe12tgh2ij3EEayHz1Db7Kkq5U9T7.1tJD1hMFxYYt9rHcYuvCMLdCn4AZdPfy4HPaavNWn8")
		cRef := shouldLoadRef("111A7748JQuyE1ARrnWpTdY44pe5k1jss62udfTGk8v.1tJD1hMFxYYt9rHcYuvCMLdCn4AZdPfy4HPaavNWn8")
		rv = append(rv, XXX_artifacts.NewObjectDescriptor(
			/* head:         */ pRef,
			/* state:        */ *pRef.Record(),
			/* prototype:    */ &cRef,
