...
func __INSMETHOD__Hello(_self *HelloWorlder) {
	_self.Hello()
}

func __INSMETHOD__Fail(_self *HelloWorlder) {
	_self.Fail()
}

func __INSMETHOD__Echo(_self *HelloWorlder, s interface{}) {
	_self.Echo(s.(string))
}

func __INSMETHOD__ConstEcho(_self *HelloWorlder, s interface{}) {
	_self.ConstEcho(s.(string))
}

var __INSEXPORTHelloWorlder HelloWorlder
