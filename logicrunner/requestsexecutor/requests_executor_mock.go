...
type RequestsExecutorMock struct {
	...
	funcExecute          func(ctx context.Context, current *transcript.Transcript) (r1 artifacts.RequestResult, err error)
	inspectFuncExecute   func(ctx context.Context, current *transcript.Transcript)
	afterExecuteCounter  uint64
	beforeExecuteCounter uint64
	ExecuteMock          mRequestsExecutorMockExecute

	funcExecuteAndSave          func(ctx context.Context, current *transcript.Transcript) (r1 insolar.Reply, err error)
	inspectFuncExecuteAndSave   func(ctx context.Context, current *transcript.Transcript)
	...
	funcSave          func(ctx context.Context, current *transcript.Transcript, res artifacts.RequestResult) (r1 insolar.Reply, err error)
	inspectFuncSave   func(ctx context.Context, current *transcript.Transcript, res artifacts.RequestResult)
	afterSaveCounter  uint64
	beforeSaveCounter uint64
	SaveMock          mRequestsExecutorMockSave

	funcSendReply          func(ctx context.Context, current *transcript.Transcript, re insolar.Reply, err error)
	inspectFuncSendReply   func(ctx context.Context, current *transcript.Transcript, re insolar.Reply, err error)
...
func (mmExecute *mRequestsExecutorMockExecute) Expect(ctx context.Context, current *transcript.Transcript) *mRequestsExecutorMockExecute {
...
func (mmExecute *mRequestsExecutorMockExecute) Inspect(f func(ctx context.Context, current *transcript.Transcript)) *mRequestsExecutorMockExecute {
...
func (mmExecute *mRequestsExecutorMockExecute) Set(f func(ctx context.Context, current *transcript.Transcript) (r1 artifacts.RequestResult, err error)) *RequestsExecutorMock {
	if mmExecute.defaultExpectation != nil {
...
// Then helper
func (mmExecute *mRequestsExecutorMockExecute) When(ctx context.Context, current *transcript.Transcript) *RequestsExecutorMockExecuteExpectation {
	if mmExecute.mock.funcExecute != nil {
		mmExecute.mock.t.Fatalf("RequestsExecutorMock.Execute mock is already set by Set")
	}
...
func (mmExecute *RequestsExecutorMock) Execute(ctx context.Context, current *transcript.Transcript) (r1 artifacts.RequestResult, err error) {
...
func (mmExecuteAndSave *mRequestsExecutorMockExecuteAndSave) Expect(ctx context.Context, current *transcript.Transcript) *mRequestsExecutorMockExecuteAndSave {
...
func (mmExecuteAndSave *mRequestsExecutorMockExecuteAndSave) Inspect(f func(ctx context.Context, current *transcript.Transcript)) *mRequestsExecutorMockExecuteAndSave {
...
func (mmExecuteAndSave *mRequestsExecutorMockExecuteAndSave) Set(f func(ctx context.Context, current *transcript.Transcript) (r1 insolar.Reply, err error)) *RequestsExecutorMock {
	if mmExecuteAndSave.defaultExpectation != nil {
...
// Then helper
func (mmExecuteAndSave *mRequestsExecutorMockExecuteAndSave) When(ctx context.Context, current *transcript.Transcript) *RequestsExecutorMockExecuteAndSaveExpectation {
	if mmExecuteAndSave.mock.funcExecuteAndSave != nil {
		mmExecuteAndSave.mock.t.Fatalf("RequestsExecutorMock.ExecuteAndSave mock is already set by Set")
	}
...
func (mmExecuteAndSave *RequestsExecutorMock) ExecuteAndSave(ctx context.Context, current *transcript.Transcript) (r1 insolar.Reply, err error) {
...
func (mmSave *mRequestsExecutorMockSave) Expect(ctx context.Context, current *transcript.Transcript, res artifacts.RequestResult) *mRequestsExecutorMockSave {
...
func (mmSave *mRequestsExecutorMockSave) Inspect(f func(ctx context.Context, current *transcript.Transcript, res artifacts.RequestResult)) *mRequestsExecutorMockSave {
...
func (mmSave *mRequestsExecutorMockSave) Set(f func(ctx context.Context, current *transcript.Transcript, res artifacts.RequestResult) (r1 insolar.Reply, err error)) *RequestsExecutorMock {
	if mmSave.defaultExpectation != nil {
...
// Then helper
func (mmSave *mRequestsExecutorMockSave) When(ctx context.Context, current *transcript.Transcript, res artifacts.RequestResult) *RequestsExecutorMockSaveExpectation {
	if mmSave.mock.funcSave != nil {
		mmSave.mock.t.Fatalf("RequestsExecutorMock.Save mock is already set by Set")
	}
...
func (mmSave *RequestsExecutorMock) Save(ctx context.Context, current *transcript.Transcript, res artifacts.RequestResult) (r1 insolar.Reply, err error) {
...
func (mmSendReply *mRequestsExecutorMockSendReply) Expect(ctx context.Context, current *transcript.Transcript, re insolar.Reply, err error) *mRequestsExecutorMockSendReply {
...
func (mmSendReply *mRequestsExecutorMockSendReply) Inspect(f func(ctx context.Context, current *transcript.Transcript, re insolar.Reply, err error)) *mRequestsExecutorMockSendReply {
...
func (mmSendReply *mRequestsExecutorMockSendReply) Set(f func(ctx context.Context, current *transcript.Transcript, re insolar.Reply, err error)) *RequestsExecutorMock {
	if mmSendReply.defaultExpectation != nil {
...
func (mmSendReply *RequestsExecutorMock) SendReply(ctx context.Context, current *transcript.Transcript, re insolar.Reply, err error) {
