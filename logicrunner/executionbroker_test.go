...
func (s *LogicRunnerTestSuite) TestImmutableOrder() {
	...
	mutableTranscript := common.NewTranscript(s.ctx, mutableRequestRef, mutableRequest)
	...
	immutableTranscript1 := common.NewTranscript(s.ctx, immutableRequestRef1, immutableRequest1)
	...
	immutableTranscript2 := common.NewTranscript(s.ctx, immutableRequestRef2, immutableRequest2)
	...
	s.re.ExecuteAndSaveMock.Set(func(ctx context.Context, transcript *common.Transcript) (insolar.Reply, error) {
